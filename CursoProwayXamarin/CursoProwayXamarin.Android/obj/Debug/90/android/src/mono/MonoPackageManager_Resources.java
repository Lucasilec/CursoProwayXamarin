...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CursoProwayXamarin.Android.dll" comes first in this list. */
		"CursoProwayXamarin.Android.dll",
		"CursoProwayXamarin.dll",
		"FormsViewGroup.dll",
